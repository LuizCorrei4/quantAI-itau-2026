...
def main():
    ...
    # 4. Geração Automática do Relatório Markdown
    print("Gerando relatório Markdown...")
    relatorio_md = f"""# Teste de Robustez: Monte Carlo (Macacos Aleatórios)
...
*   **Simulações:** {N_SIMULACOES} caminhos de carteiras aleatórias.
