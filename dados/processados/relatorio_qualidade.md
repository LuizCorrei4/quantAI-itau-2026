...
- Observações válidas: **937,750**
- Média: -0.00009 | Desvio padrão: 0.0305
- Assimetria: 0.11 | Curtose: 24.9
- Retornos com |r| > 25%: 734 (0.0783% das observações)
...
- Tickers distintos que já passaram pelo universo: **156**
- Empresas distintas (radical de 4 letras): **155**
- Renovação média do universo: **1.7 ações/mês** (2.1%)
...
O universo tem **156** tickers distintos ao longo de 184 rebalanceamentos. Destes, **4** são séries que terminam antes do último pregão (2026-08-05) — ou seja, empresas que saíram da bolsa e cujo histórico está preservado no backtest.

**Séries encerradas presentes no universo:**

| Ticker | Empresa | Fim da série | Meses no universo |
|---|---|---|---|
| PRML3 | Prumo Logística | 2018-03-09 | 45 |
| VVAR11 | Via Varejo units | 2018-11-23 | 56 |
| OGXP3 | OGX Petróleo | 2019-01-10 | 37 |
| BRPR3 | BR Properties | 2024-08-06 | 84 |
